...
class DownloadRequest(BaseModel):
    ...
    year: Optional[int] = Field(
        default=None, ge=2020, le=2030, description="Année des factures à télécharger"
    )
    ...
    date_end: Optional[str] = Field(
        default=None, description="Fin de plage au format YYYY-MM-DD"
    )
...
class OTPResponse(BaseModel):
    ...
    requires_otp: bool = Field(
        default=False, description="Indique si un code OTP est toujours requis"
    )
